...
public:
	...
	static void CalculateMyAge(clsDate Date) {
		time_t t = time(0);
		tm* now = localtime(&t);
		short Year = now->tm_year + 1900;
		cout << "Your Current Age (in years) Is: " << (Year - Date.Year) << " Years Old";
	...
	static string GetSystemTime() {
		...
		string T = "AM";
			...
			return  to_string(Hour) + ":" + to_string(Minute) + ":" + to_string(Second) +" "+ T;
